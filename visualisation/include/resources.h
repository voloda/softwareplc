...
#ifndef _VISUALISATION_RESOURCES_H_
	#define _VISUALISATION_RESOURCES_H_

	#define ID_VISUALISATION_MAIN_WINDOW	100

	#define	IDB_SET_VALUE			101
	#define IDSP_ROTATION_PER_SEC		102
	#define ID_PLOT				103
#endif
